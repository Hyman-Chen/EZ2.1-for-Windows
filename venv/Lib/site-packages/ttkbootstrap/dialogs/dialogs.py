...
class Dialog(BaseWidget):
    ...
    def _locate(self):
        ...
        x = int(master.winfo_rootx()+master.winfo_width() / 2-100)
        y = int(master.winfo_rooty()+master.winfo_height() / 2-100)
        #
        # x = master.winfo_rootx()/2+master.winfo_width() / 2
        # y = master.winfo_rooty()/2+master.winfo_height() / 2
        ...
        **kwargs,
        ...
        Parameters:
            ...
            buttons (List[str]):
                ...
                `['好', 'Cancel']`. Alternatively, you can assign a
        ...
        if buttons is None:
            self._buttons = [
                ...
                f"{MessageCatalog.translate('好')}:primary",
            ]
        else:
...
class DatePickerDialog:
    ...
    def _set_title(self):
        ...
        _titledate = f'{self.date.strftime("%Y{y}%m{m}").format(y="年",m="月")}'
    ...
    def _header_columns(self):
        ...
        """
        weekdays = [
            MessageCatalog.translate("一"),
            MessageCatalog.translate("二"),
            MessageCatalog.translate("三"),
            MessageCatalog.translate("四"),
            MessageCatalog.translate("五"),
            MessageCatalog.translate("六"),
            MessageCatalog.translate("日"),
        ]
...
class FontDialog(Dialog):
    ...
    def create_buttonbox(self, master):
        ...
        ok_btn = ttk.Button(
            master=container,
            bootstyle="primary",
            text=MessageCatalog.translate("好"),
...
class Messagebox:
    ...
    @staticmethod
    def show_info_success(message, title=" ", parent=None, alert=False, **kwargs):
        """green
        Display a modal dialog box with an 好 button and an INFO
        icon.
        ...
        # dialog.iconbitmap('./data/image/ico.ico')
    ...
    @staticmethod
    def show_info_primary(message, title=" ", parent=None, alert=False, **kwargs):
        """blue
        Display a modal dialog box with an 好 button and an INFO
        icon.
    ...
    @staticmethod
    def show_info_danger(message, title=" ", parent=None, alert=False, **kwargs):
        """danger
        Display a modal dialog box with an 好 button and an INFO
        icon.
    ...
    @staticmethod
    def show_info_info(message, title=" ", parent=None, alert=False, **kwargs):
        """info
        Display a modal dialog box with an 好 button and an INFO
        icon.
    ...
    @staticmethod
    def show_info_warning(message, title=" ", parent=None, alert=False, **kwargs):
        """warning
        Display a modal dialog box with an 好 button and an INFO
        icon.
    ...
    def show_warning(message, title=" ", parent=None, alert=True, **kwargs):
        """Display a modal dialog box with an 好 button and a
    ...
    def show_error(message, title=" ", parent=None, alert=True, **kwargs):
        """Display a modal dialog box with an 好 button and an
    ...
    def show_question1(
        ...
        title=" ",
        parent=None,
        buttons=["否:(LINK,SECONDARY)", "是:(LINK,SUCCEES)"],
        alert=True,
        **kwargs,
    ):
    ...
    def ok(message, title=" ", alert=False, parent=None, **kwargs):
        """Display a modal dialog box with an 好 button and and optional
        bell alert.
    ...
    def okcancel(message, title=" ", alert=False, parent=None, **kwargs):
        """Displays a modal dialog box with 好 and Cancel buttons and
